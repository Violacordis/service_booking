...
router.post("/", (0, validate_middleware_1.validate)(branch_validator_1.createBranchSchema), controller.createBranches);
router.get("/", (0, validate_middleware_1.validate)(branch_validator_1.getBranchesQuerySchema), controller.fetchBranches);
